	...
	return {
		...
		initCore : function () {
			...
			(function (H) {
				...
				H.last_item = function () {
					return def(this[0])? DOMAssistant.addMethodsToElm(this[this.length-1]) : null;
				};
				H.end = function () {
		...
		hasChild: function (elm) {
			return this === document || this !== elm && (this.contains? this.contains(elm) : !!(this.compareDocumentPosition && this.compareDocumentPosition(elm) & 16));
		},
